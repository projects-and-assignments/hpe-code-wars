...
WHAT IT TESTS: 
    1.) Ability to parse integers out of string data from a file
    2.) Ability to control order of operations in a program
    3.) Ability to multiply integers together
