...
ESTIMATED STUDENT COMPLETION TIME NEEDED: 4 mins
AUTHOR: Robert McAdams, mcadams@hpe.com, linkedin.com/in/RobertMcadams
LAST MODIFIED: 2021-02-22
WHAT IT TESTS: 
    1.) Ability to parse an integer out of string data from a file
    2.) Ability to map an integer to a string value
    3.) Ability to select a mapped value for an integer for output
...
def Main(lines=[]):
    ...
    if (len(lines) > 0):
        ...
        num = int(lines[0])
        print(f'Number {numbers[num]} is alive!')
    else:
